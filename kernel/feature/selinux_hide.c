...
#ifdef CONFIG_KSU_SUSFS
	// - the fake selinuxfs status page & the selinuxfs transaction write spoofing
	//   are handled by the susfs-patched kernel directly (see 50_add_susfs patch)
	// - fake_status is initialized lazily via fake_status_initialize_key
